<template>
    <div id="detailContainer"  class="slideEnterActive">
        <Header title="影片详情">
...
<style scoped>
#detailContainer { position: absolute; top: 0; left: 0; z-index: 100; width: 100; min-height: 100%; background: white;}
#detailContainer .slideEnterActive { animation: .3s slideMove;}
@keyframes slideMove {
